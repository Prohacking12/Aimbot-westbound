...
function TargetSystem.getClosestEnemy(maxDistance, targetTeam)
...
function TargetSystem.getClosestAnimal(maxDistance)
...
function TargetSystem.getCurrentTarget()
    return lockedTargetPart or 
           TargetSystem.getClosestEnemy(Homelander.Config.Aimbot.PlayerMaxDistance, Homelander.Config.Aimbot.TargetTeamName) or 
           TargetSystem.getClosestAnimal(Homelander.Config.Aimbot.AnimalMaxDistance)
end

function TargetSystem.switchTargetTeam()
...
function TargetSystem.toggleLockTarget()
    if lockedTargetPart then
        lockedTargetPart = nil
    else
        lockedTargetPart = TargetSystem.getClosestEnemy(Homelander.Config.Aimbot.PlayerMaxDistance, Homelander.Config.Aimbot.TargetTeamName)
    end
    if Homelander.GUI then
        Homelander.GUI.updateButtons()
    end
